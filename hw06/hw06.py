...
def is_bst(t):
    ...
    if t.is_leaf():
        return True
    if len(t.branches) == 1:
        t_branch = t.branches[0]
        return is_bst(t_branch) and (bst_min(t_branch) > t.label or bst_max(t_branch) <= t.label)
    elif len(t.branches) == 2:
        t_branch1, t_branch2 = t.branches
        return is_bst(t_branch1) and is_bst(t_branch2) and bst_min(t_branch2) > t.label >= bst_max(t_branch1)
    else:
        return False
